...
 GitHub      : https://github.com/Sultan-Baloch
 YouTube     : Termux Master
 Telegram    : https://t.me/meersulan787
 Blogspot    : https://meersultanlrk.blogspot.com
--------------------------------------------------
"""
def tik():
	titik = ['.   ','..  ','... ']
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://facebook.com/meersultanofficial')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mloveMSK\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mloveMSK\033[1;95m•◈•══════••◈•"
		try:
	...
	print('           \033[1;91mSultan start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mloveMSK\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By SULTAN hacker--•◈•---»" #Dev:SULTAN
